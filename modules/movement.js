...
export default function movement(data, type) {
    ...
    if (type === 'display') {
      ...
      if (m >= 1) {
        ...
        directionMove = "<span class=text-danger><i class='fa-solid fa-chevron-up'></i></span>";
      } else if (m < 0 ) {
        // Position change green, you've overtaken cars!
        directionMove = "<span class=text-success<i class='fa-solid fa-chevron-down'></i></span>";
      } else {
